...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forRoot({
                ...
                synchronize: true
            }), auth_validate_module_1.AuthValidateModule, user_module_1.UserModule, products_module_1.ProductsModule, product_supplier_module_1.ProductSupplierModule, shopping_cart_module_1.ShoppingCartModule, cart_module_1.CartModule, cart_items_module_1.CartItemsModule, auth_service_module_1.AuthServiceModule, chat_module_1.ChatModule],
        controllers: [],
        providers: [],
    })
], AppModule);
